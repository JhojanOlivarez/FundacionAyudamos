...
const impactItems = [
  { icon: IconHeart, label: 'Vidas Impactadas ❤️', value: 15000, color: '#FFD700' },
  { icon: IconStethoscope, label: 'Consultas Realizadas 🩺', value: 12000, color: '#4169E1' },
  { icon: IconMedicineSyrup, label: 'Medicamentos Donados 💊', value: 3000, color: '#DC143C' },
  { icon: IconActivity, label: 'Charlas de Salud 🗣️', value: 800, color: '#32CD32' },
  { icon: IconUsers, label: 'Voluntarios Activos 👩‍⚕️👨‍⚕️', value: 700, color: '#FF8C00' },
  { icon: IconHeartCheck, label: 'Campañas de Vacunación 💉', value: 100, color: '#8A2BE2' },
];
        ...
        >
          <motion.div variants={cardVariants}>
            ...
            <Text className={classes.description}>
              Tu generosidad ayuda a mejorar la salud de nuestra comunidad. Cada donación fortalece nuestros programas de salud y bienestar, creando un impacto duradero en la sociedad.
            </Text>
          </motion.div>
              ...
              <motion.div variants={cardVariants}>
                <Card shadow="lg" radius="lg" className={classes.impactCard}>
                  ...
                  <Text className={classes.impactDescription}>
                    Juntos, estamos construyendo un futuro más saludable. Mira cómo tu apoyo está cambiando vidas:
                  </Text>
